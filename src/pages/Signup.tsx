...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome to Tearix!",
        description: "Your account has been successfully created. Start generating amazing content!",
      });
      navigate('/dashboard');
    } catch (error: any) {
      toast({
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-400">
              Join Tearix and start creating amazing content
            </CardDescription>
          </CardHeader>
